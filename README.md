...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [NeuralBase](https://github.com/NeuralBase) open-source ecosystem.
...
The `dashboard` application is the web frontend for NeuralBase, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/NeuralBase/dashboard
cd dashboard
npm install
```
